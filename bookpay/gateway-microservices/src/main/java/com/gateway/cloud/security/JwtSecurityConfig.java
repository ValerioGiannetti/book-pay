...
public class JwtSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] CLIENTE_MATCHER = {"/gateway-cliente/api/gestione/prenotazioni/**"};

	private static final String[] COMMERCIANTE_MATCHER = { "/gateway-articoli/api/gestione/articoli/**",
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling()
				...
				.antMatchers(COMMERCIANTE_MATCHER).hasAnyRole("COMMERCIANTE","ADMIN").anyRequest().authenticated();
