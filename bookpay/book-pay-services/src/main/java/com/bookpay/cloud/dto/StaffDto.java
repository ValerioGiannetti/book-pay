...
public class StaffDto {
	...
	private String idNegozioEsercente;
	...
	public String getIdNegozioEsercente() {
		return idNegozioEsercente;
	}

	public void setIdNegozioEsercente(String idNegozioEsercente) {
		this.idNegozioEsercente = idNegozioEsercente;
	}
